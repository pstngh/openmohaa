...
- The external service was verified active on 2026-08-10 with the independently checked artifact for passing commit `6e472321`; its live binary pair matched that artifact, both intended UDP ports listened, and fresh schema 7 telemetry was growing. The exact `6938284a` pair remains at `deploy-backups/pre-6e472321` for rollback.
