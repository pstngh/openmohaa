...
textures/common/snowweaponclip
{
	qer_editorimage textures/common/snowweaponclip.tga
	qer_keyword utility
	qer_trans .4
	surfaceparm snow
   	surfaceparm nodraw
...
textures/common/white_volumetric_simple
{
	qer_editorimage textures/common/qer_volumetric_fade.tga
	qer_keyword utility
	qer_trans .4
...
// for use as a collision volume for stone
textures/common/waterclip
{
	qer_editorimage textures/common/waterclip.tga
	qer_keyword utility
	qer_trans .4
	surfaceparm water
   	surfaceparm nodraw
