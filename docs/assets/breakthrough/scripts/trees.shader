...
tree1sprite // Sprite version
{
	...
	cull none
	{
		...
		depthWrite
		alphaFunc GE128
		alphaGen oneMinusTikiDistFade 1216 512
		rgbGen lightingGrid
	}
}
...
tree2sprite //birch sprite
{
	...
	cull none
	{
		...
		depthWrite
		alphaFunc GE128
		alphaGen oneMinusTikiDistFade 900 500
		rgbGen lightingGrid
	}
}
...
static_squatpalmsprite // Sprite version
{
	...
	cull none
	{
		...
		depthWrite
		alphaFunc GE128
		alphaGen oneMinusTikiDistFade 121600 512
		rgbgen lightingSpherical
	}
} 
...
//snowy fir tree
fir_snowy_trunk_rings
{
	qer_editorimage textures/models/natural/fir_snowy_trunk_rings.tga
	{
		map textures/models/natural/fir_snowy_trunk_rings.tga
		rgbGen lightingSpherical
		//rgbGen constant .24 .24 .25 //kinda not acceptable
	}
}

fir_snowy_trunk
{
	qer_editorimage textures/models/natural/fir_snowy_trunk.tga
	{
		map textures/models/natural/fir_snowy_trunk.tga
		rgbGen lightingspherical
		//rgbGen constant .14 .15 .15 //kinda not acceptable
	}
}
...
{
	cull back
	qer_editorimage textures/models/natural/fir_trunk_splinters.tga
	{
		clampmap textures/models/natural/fir_trunk_splinters.tga
		alphaFunc GE128
		alphaGen distFade 512 512
		rgbGen lightingSpherical
		//rgbGen constant .13 .14 .14 //kinda not acceptable
	}
}

fir_snowy_branch_circular
{
	qer_editorimage textures/models/natural/fir_snowy_branch_circular.tga
	cull none
	//deformVertexes wave 24 sin 2 3 0 .25 1 0
	{
		clampmap textures/models/natural/fir_snowy_branch_circular.tga
		alphaFunc GE128
		alphaGen distFade 512 512
		rgbGen lightingSpherical
		//rgbGen constant .036 .0405 .042 //kinda not acceptable
	}
}


fir_snowy_branch_small
{
	qer_editorimage textures/models/natural/fir_snowy_branch_small.tga
	cull none
	deformVertexes flap t 24 sin 0.25 0.75 0 .15 1 0
	{
		clampmap textures/models/natural/fir_snowy_branch_small.tga
		alphaFunc GE128
		rgbGen lightingSpherical
		//rgbGen constant .05184 .05832 .059 //kinda not acceptable


	}
}

fir_snowy_branch_snowyfoliage
{
	qer_editorimage textures/models/natural/fir_snowy_branch_snowyfoliage.tga
	cull none
	deformVertexes flap t 24 sin 0.35 0.85 0 .15 1 0
	{
		clampmap textures/models/natural/fir_snowy_branch_snowyfoliage.tga
		alphaFunc GE128
		rgbGen lightingSpherical //kinda not acceptable
		//rgbGen constant .088 .104 .104
	}
}

//commontree falling
falling_tree1_1	// Trunk
{
	qer_editorimage textures/models/natural/tree1_1.tga
	{
		map textures/models/natural/tree1_1.tga
...
falling_tree1_2 // Small fill branches
{
	qer_editorimage textures/models/natural/tree1_2.tga
	nomipmaps
	cull none
...
falling_tree1_4 // Horizontal cross section
{
	qer_editorimage textures/models/natural/tree1_4.tga
	nomipmaps
...
falling_tree1sprite // Sprite version
{
	qer_editorimage textures/models/natural/tree1sprite.tga
	qer_trans 0
	nomipmaps
...
Af_P_Shrub
{
	qer_editorimage textures/models/natural/Af_P_Shrub.tga
	cull none
	{
		clampmap textures/models/natural/Af_P_Shrub.tga
		depthWrite
		alphafunc GE128
		rgbGen lightingSpherical
	}
