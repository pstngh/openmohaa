...
beam_cross
{
		...
		{
	   		map textures/fx/tehao/beam_cross.tga
	   		blendFunc alphaadd
		}
}
...
{	
	...
	nopicmip
	nomipmaps
	qer_editorimage textures/models/items/grandfathers_clock_glass2.tga
//	{
...
//	}
	{
		map textures/models/items/grandfathers_clock_glass2.tga
		rgbGen lightingSpherical
		alphafunc GT0
		depthwrite
		//blendfunc blend
...
// STICKYBOMBS
//
Inventory_StickyBomb_stickybomb
{
	qer_editorimage textures/models/items/StickyBomb/stickybomb.tga
	{
		map textures/models/items/StickyBomb/stickybomb.tga
		rgbGen lightingSpherical
	}
}

Inventory_StickyBomb_stickybomb_pulsing
{
	qer_editorimage textures/models/items/StickyBomb/stickybomb.tga
	{
		map textures/models/items/StickyBomb/stickybomb.tga
...
sticky_backpack
{
	qer_editorimage textures/models/items/stickybomb_pickup/sticky_backpack.jpg
	{
		map textures/models/items/stickybomb_pickup/sticky_backpack.jpg
		rgbGen lightingSpherical
	}
}
...
radiopack
{
	qer_editorimage textures/models/equipment/radiopack.tga
	{
		map textures/models/equipment/radiopack.tga
		rgbGen lightingSpherical
	}
}
Sc_Al_US_Inf_gear
{
	qer_editorimage textures/models/equipment/Sc_Al_US_Inf_gear.tga
	{
		map textures/models/equipment/Sc_Al_US_Inf_gear.tga
		rgbGen lightingSpherical
	}
}
SC_AL_BRIT_INF_GEAR
{
	qer_editorimage textures/models/equipment/SC_AL_BRIT_INF_GEAR.tga
	{
		map textures/models/equipment/SC_AL_BRIT_INF_GEAR.tga
		rgbGen lightingSpherical
	}
}
Sc_P_CampFire
{
	qer_editorimage textures/models/miscobj/campfire02.tga
	{
		map textures/models/miscobj/campfire02.tga
		rgbGen lightingSpherical
	}
}
Sc_P_FireStone
{
	qer_editorimage textures/models/miscobj/campfireStone.tga
	{
		map textures/models/miscobj/campfireStone.tga
		rgbGen lightingSpherical
	}
}
Sc_AL_US_InfPack
...
parachute_pack
{
	qer_editorimage textures/models/gear/us_gear/Parachute_pack.tga
	{
		map textures/models/gear/us_gear/Parachute_pack.tga
		rgbGen lightingSpherical
	}
}
parachute_pack2
{
	qer_editorimage textures/models/gear/us_gear/Parachute_pack2.tga
	{
		map textures/models/gear/us_gear/Parachute_pack2.tga
		rgbGen lightingSpherical
	}
}
Crate_1942
{
	qer_editorimage textures/items_various/Crate_1942.tga
	{
		map textures/items_various/Crate_1942.tga
		rgbGen lightingSpherical
	}
}
colonel_holster
{
	{
		map textures/models/miscobj/german_holster.tga
		rgbGen lightingSpherical
	}
}