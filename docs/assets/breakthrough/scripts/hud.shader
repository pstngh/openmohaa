...
textures/hud/It_W_Bomba
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/It_W_Bomba.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
textures/hud/It_W_BombaBreda
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/It_W_BombaBreda.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
textures/hud/clip_piat
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/clip_piat.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
textures/hud/clip_cangrenade
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/clip_cangrenade.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
...
textures/hud/clip_pistol_small
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/clip_pistol_small.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
...
textures/hud/clip_riflegrenade
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/clip_riflegrenade.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
...
textures/hud/clip_nebelwerfer
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/clip_nebelwerfer.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
textures/hud/clip_landmineaxis
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/clip_landmineaxis.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
textures/hud/clip_landmineallies
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/clip_landmineallies.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}

textures/hud/clip_aa_gun
{
//	surfaceparm nolightmap
//	nomipmaps
//	nopicmip
	qer_editorimage textures/hud/clip_aa_gun.tga
	{
		map textures/hud/clip_aa_gun.tga
		blendfunc blend
	}
	{
		map textures/hud/red_mask.tga
		blendFunc GL_SRC_ALPHA GL_ONE // this is an additive blend that can be controled with the alpha level
		alphagen oneMinusvertex
	}
}
...
// the main body of the fuse timer
textures/hud/fusebase
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		nodepthtest
		clampmap textures/hud/fusebase.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}

// the main body of the fuse timer set to be shootable
textures/hud/fusebase_shoot
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		nodepthtest
		clampmap textures/hud/fusebase_shoot.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}

//this is main part of the fuse
textures/hud/fusetile
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		nodepthtest
		map textures/hud/fusetile.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}

//this is the spark of the fuse
textures/hud/fusespark
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	...
	{
		nodepthtest
		clampmap textures/hud/fusespark.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}

//this is the smoke of the fuse
textures/hud/fusesmoke
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	...
	{
		nodepthtest
		clampmap textures/hud/fusesmoke.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
...
// MOHEP2, JABBOTT
textures/hud/instamsg_group_f
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		clampmap textures/hud/instamsg_group_f.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}

textures/hud/clip_pzb41
{
	surfaceparm nolightmap
	nomipmaps
	nopicmip
	{
		map textures/hud/clip_pzb41.tga
		blendFunc blend
		alphaGen oneMinusVertex
	}
}
