...
static_hedgehog_snowy
{
	qer_editorimage textures/models/items/hedgehog_snowy.tga
	cull none
	{
		map textures/models/items/hedgehog_snowy.tga
		rgbgen lightingSpherical
	}
}
...
static_lrock2
{
	qer_editorimage textures/wilderness/wldrrckset1_1.tga
	{
