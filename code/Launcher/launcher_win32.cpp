...
// Dark theme colors
#    define CLR_BG            RGB(20, 20, 20)
#    define CLR_BG_EDIT       RGB(35, 35, 35)
#    define CLR_TEXT           RGB(220, 220, 220)
#    define CLR_TEXT_DIM       RGB(130, 130, 130)
#    define CLR_TEXT_DIS       RGB(100, 100, 100)
#    define CLR_BORDER         RGB(60, 60, 60)
#    define CLR_BTN           RGB(45, 45, 45)
#    define CLR_BTN_HOVER     RGB(60, 60, 60)
#    define CLR_BTN_PRESSED   RGB(30, 30, 30)
#    define CLR_ACCENT         RGB(123, 79, 191)
#    define CLR_ACCENT_HOVER  RGB(143, 99, 211)
#    define CLR_SEG_ACTIVE    RGB(123, 79, 191)
#    define CLR_SEG_INACTIVE  RGB(40, 40, 40)
#    define CLR_SEG_HOVER     RGB(55, 55, 55)
