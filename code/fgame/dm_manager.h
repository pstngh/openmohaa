...
private:
    ...
    // Added in OPM
    bool m_bRoundFreezeActive;
    int  m_iRoundCountdown;
...
public:
    ...
    // Added in OPM
    bool       IsRoundFreezeActive(void) const;
...
// Added in OPM
inline bool DM_Manager::IsRoundFreezeActive(void) const
{
    return m_bRoundFreezeActive;
}
