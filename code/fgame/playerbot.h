...
private:
    ...
    int  m_iNextStrafeChangeTime;    // When to change phase or combat side
    ...
    float  CalculateMoveProbeFraction(const usercmd_t& botcmd, float distance) const;
    float  CalculateStrafeProbeFraction(
